...
Here we can see that the data is correlated up through about 12 days in the past.  This definitely violates our assumption of independence.
...
If you look closely it appears that the residuals are all negative for a time then they move to be all positive. From this we see that we still haven't adjusted our model for the autocorrelation that is evidenced in this zoomed in residual plot. To do thise we'll need to take a look at some time series models.
